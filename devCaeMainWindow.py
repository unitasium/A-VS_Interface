...
from devToolsetGui import DEVToolsetGui

# Define the class 
class DEVCaeMainWindow(AFXMainWindow): 
    ...
    def __init__(self, app, windowTitle = ''):
        ...
        self.registerToolset(DEVToolsetGui(), GUI_IN_TOOLBOX|GUI_IN_TOOLBAR)                 # <----- SwiftComp toolset
