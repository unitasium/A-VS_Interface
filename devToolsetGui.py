...
class DEVToolsetGui(AFXToolsetGui):
    ...
    def __init__(self):
        ...
        AFXToolsetGui.__init__(self, 'nerv')

        # Toolbox buttons
        toolbar_group_1 = AFXToolbarGroup(self, title='NERV Toolset')
        ...
        AFXToolButton(p     = toolbar_group_1, 
                      ...
                      tgt   = self, 
                      sel   = self.ID_YZview)
        FXMAPFUNC(self, SEL_COMMAND, self.ID_YZview, DEVToolsetGui.setYZview)
        ...
        AFXToolButton(p     = toolbar_group_1, 
                      label = '\tTest', 
                      icon  = ic, 
                      tgt   = ScLayerTypeManagerForm(self), 
                      sel   = AFXMode.ID_ACTIVATE)
    ...
    def getKernelInitializationCommand(self):
        ...
        h = 'import'
        h += ' userDataSG, abqClasses, scHomoMain, scMacroMat, scLocalMain'
